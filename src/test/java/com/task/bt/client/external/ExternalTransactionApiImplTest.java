...
class ExternalTransactionApiImplTest {
    ...
    void testFetchTransactionsWithRetries() {
        ...
        when(transactionFetcher.fetchTransactions(apiUrl, 1, 20, Transaction.class))
        ...
        await().atMost(3, SECONDS).untilAsserted(() -> {
            CompletableFuture<List<Transaction>> result = externalTransactionApi.fetchTransactions(apiUrl, 1, 20, Transaction.class);

            verify(transactionFetcher, times(4)).fetchTransactions(apiUrl, 1, 20, Transaction.class);
